...
3.  Implement the logic to list datasets:
    ...
    ```
4.  Open `client.py`.
5.  Find the `create_payload` function (around line 10). This is a helper to avoid typing your password for every call. Replace the code inside with:
    ```python
    ...
    return payload
    ```
6.  Find the `TODO: Task 1` section in the `main` function (around line 41). Add the code to call the new endpoint:
    ```python
...
3.  Find **Step 3** (Read content, manipulate it, and write to temp_out.txt). Add this code:
    ```python
...
4.  Find **Step 4** (Upload temp_out.txt to output_ds). Add this code:
    ```python
...
1.  Find the `TODO: Task 2` section (around line 47). Add the code to call the manipulation endpoint:
    ```python
...
3.  Implement the logic to download and return raw content:
    ...
    ```
4.  Open `client.py`.
5.  Find the `TODO: Task 3` section (around line 54).
